...
def generate_response(images, query, session_id, resized_height=280, resized_width=280, model_choice='gpt4'):
    ...
    try:
        ...
        if model_choice == 'gpt4':
            ...
            try:
                query += ". Be sure to include the relevant section names and numbers, page numbers, and any parenthetical references found in the text that you cite from the document."
